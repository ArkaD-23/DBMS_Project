...
VALUES	('John Smith', 26, 'Gold', '2025-06-15'),
...
# INSERTING RECORDS INTO trainers TABLE

INSERT INTO Trainers (Name, Specialization) 
VALUES	('Rahul Sharma', 'Strength Training'),
...
# INSERTING RECORDS INTO Sessions TABLE

INSERT INTO Sessions (MemberID, TrainerID, Date, Duration) 
VALUES	(3, 1, '2025-02-25', 50),
				(1, 4, '2025-02-27', 40),
				(5, 2, '2025-02-28', 75),
				(7, 3, '2025-03-01', 60),
				(2, 6, '2025-03-03', 90),
